...
async def attendre_reponse(ctx, bot, message_bot):
    """Attend la réponse de l'utilisateur dans le chat."""
    def check(m):
...
async def attendre_image(ctx, bot, message_bot):
    """Attend une image ou une URL envoyée dans le chat."""
    def check(m):
        return m.author == ctx.author and m.channel == ctx.channel
...
class EmbedBuilderView(discord.ui.View):
    def __init__(self, ctx, bot, salon, msg_builder):
    ...
    async def select_callback(self, interaction: discord.Interaction):
        ...
        if choix == "titre":
            ...
            if reponse:
                ...
                await self.ctx.channel.send("✅ Titre mis à jour !", delete_after=3)
            ...
            if reponse:
                ...
                await self.ctx.channel.send("✅ Description mise à jour !", delete_after=3)
            ...
            if reponse:
                ...
                await self.ctx.channel.send("✅ Auteur mis à jour !", delete_after=3)
            ...
            if reponse:
                ...
                await self.ctx.channel.send("✅ Footer mis à jour !", delete_after=3)
            ...
            if url and url != "skip":
                ...
                await self.ctx.channel.send("✅ Thumbnail mis à jour !", delete_after=3)

        elif choix == "timestamp":
            self.embed.timestamp = datetime.utcnow()
            await self.ctx.channel.send("✅ Timestamp mis à jour à maintenant !", delete_after=3)
            ...
            if url and url != "skip":
                ...
                await self.ctx.channel.send("✅ Image mise à jour !", delete_after=3)
            ...
            if reponse:
                ...
                await self.ctx.channel.send("✅ URL mise à jour !", delete_after=3)
            ...
            if reponse:
                try:
                    ...
                    await self.ctx.channel.send("✅ Couleur mise à jour !", delete_after=3)
                except ValueError:
            ...
            if reponse:
                ...
                if reponse2:
                    ...
                    await self.ctx.channel.send(f"✅ Field **{nom}** ajouté !", delete_after=3)
            ...
            if reponse:
                try:
                    ...
                    await self.ctx.channel.send("✅ Field supprimé !", delete_after=3)
            ...
            if reponse:
                try:
                    ...
                    if message.embeds:
                        ...
                        await self.ctx.channel.send("✅ Embed copié !", delete_after=3)
                    else:
...
class Embed(commands.Cog):
    ...
    async def embed(self, ctx, salon: discord.TextChannel = None):
        ...
        msg_builder = await ctx.send(embed=e)
        view = EmbedBuilderView(ctx, self.bot, salon, msg_builder)
        await msg_builder.edit(view=view)
